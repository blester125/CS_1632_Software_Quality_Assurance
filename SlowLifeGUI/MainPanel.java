...
public class MainPanel extends JPanel {
    ...
    /* Hot Spot as Identified by the profiler 
    	I converted from 
    		private int convertToInt(int x) 
    	to
    		public int convertToInt(int x)
    	to make testing earlier 
    	method returns error, NumberFormatException
    	on negative input */
    public int convertToInt(int x) {
		if (x < 0) {
    ...
    // _r is 1000 before the loop and 
    // Then is set back to 1000 after the loop
